...
\end{equation}
in which, $g_{k\sigma}$ is the free propagator of lead, and $\gamma$ is \{>, <, r, a\}. From Dyson equation, we have (different from Eq. (77) in Chap. II ?)
\begin{equation}
G^{<}=G^{r} \Sigma^{<} G^{a}
\end{equation}
...
% \end{equation}
The hamiltonian $H-H'$ cannot flip spin, so in the spin space \{$d_{\uparrow}^{\dag}$, $d_{\downarrow}^{\dag}$; $d_{\uparrow}$, $d_{\uparrow}$\}, $G^{0r}$ is diagonal
\begin{equation}
G^{0r}(E)=\left(\begin{array}{cc}
G_{n\uparrow}^{0r}(E) &0 \\
...
\end{array}\right)
\end{equation}
$H'$ in Eq. (\ref{eq:dyson-2})is given by
\begin{equation}
...
\end{array}\right) = &
\left(\begin{array}{cc}
G_{n\uparrow}^{0r}(E_{1}) &0 \\
0 & G_{n\downarrow}^{0r}(E_{1})
...
\begin{equation}
G_{1}(E_{1},E_{2}) = \gamma \int dE G_{n \uparrow}^{0r}\left(E_{1}\right) \delta(E_{1}-E-\omega) G_{n \downarrow, m \uparrow}^{r}(E,E_{2})
\end{equation}
\begin{equation}
G_{2}(E_{1},E_{2}) = \gamma\int dE G_{n \uparrow}^{0r} \left(E_{1}\right)  \delta(E_{1}-E-\omega) G_{n \downarrow, m \downarrow}^{r}(E,E_{2})
\end{equation}
\begin{equation}
G_{3}(E_{1},E_{2}) =  \gamma \int dE G_{n \downarrow}^{0r}\left(E_{1}\right)  \delta(E_{1}-E+\omega) G_{n \uparrow, m \uparrow}^{r}(E,E_{2})
\end{equation}
\begin{equation}
G_{4}(E_{1},E_{2}) = \gamma\int dE G_{n \uparrow}^{0r}\left(E_{1}\right)  \delta(E_{1}-E+\omega) G_{n \uparrow, m \downarrow}^{r}(E,E_{2})
\end{equation}
So, the $G_{1}$ term
\begin{equation}
\begin{split}
G_{n \uparrow, m \uparrow}^{r}(E_{1}, E_{2}) &= G_{n \uparrow}^{0r}\left(E_{1}\right) 2 \pi \delta\left(E_{1}-E_{2}\right) + G_{1}\left(E_{1}, E_{2}\right) \\
&= 2 \pi G_{n \uparrow}^{0r}\left(E_{1}\right) \delta\left(E_{1}-E_{2}\right) + \gamma G_{n \uparrow}^{0r}\left(E_{1}\right)  G_{n \downarrow, m \uparrow}^{r}\left(E_{1}-\omega, E_{2}\right)
\end{split}
\end{equation}
The $G_{2}$ term
\begin{equation}
...
=& \gamma G_{n \uparrow}^{0r} \left(E_{1}\right) G_{n \downarrow, m \downarrow}^{r}(E_{1}-\omega,E_{2})
\end{split}
\end{equation}
The $G_{3}$ term
\begin{equation}
...
&= \gamma G_{n \downarrow}^{0r} \left(E_{1}\right) G_{n \uparrow, m \uparrow}^{r}(E_{1}+\omega,E_{2})
\end{split}
\end{equation}
and the $G_{4}$ term
\begin{equation}
...
&= 2 \pi G_{n \downarrow}^{0r}\left(E_{1}\right) \delta\left(E_{1}-E_{2}\right) + \gamma G_{n \uparrow}^{0r}(E_{1}) G_{n \uparrow, m \downarrow}^{r}(E_{1}+\omega, E_{2})
\end{split}
\end{equation}
After collecting terms, we get
\begin{equation}
\begin{split}
G_{n \uparrow, m \uparrow}^{r}(E_{1}, E_{2}) &= 2 \pi G_{n \uparrow}^{0r}\left(E_{1}\right) \delta\left(E_{1}-E_{2}\right) + \gamma G_{n \uparrow}^{0r}\left(E_{1}\right) \gamma G_{n\downarrow}^{0r}(E_{1}-\omega)G_{n \uparrow, m \uparrow}^{r}\left(E_{1}, E_{2}\right) \\
&=\frac{2 \pi G_{n \uparrow}^{0r}\left(E_{1}\right) \delta\left(E_{1}-E_{2}\right)}{1-\gamma^{2} G_{n \uparrow}^{0r}\left(E_{1}\right) G_{n \downarrow}^{0r}\left(E_{1}-\omega\right)}
\end{split}
\end{equation}
and
\begin{equation}
G_{n \downarrow, m \downarrow}^{r}(E_{1}, E_{2}) = \frac{2 \pi G_{n \downarrow}^{0r}\left(E_{1}\right) \delta\left(E_{1}-E_{2}\right)}{1-\gamma^{2} G_{n \uparrow}^{0r}\left(E_{1}\right) G_{n \uparrow}^{0r}\left(E_{1}+\omega\right)}
\end{equation}
and
\begin{equation}
\begin{split}
G_{n \uparrow, m \downarrow}^{r}\left(E_{1}, E_{2}\right) &=  \gamma G_{n \uparrow}^{0r} \left(E_{1}\right)  G_{n \downarrow, m \downarrow}^{r}(E_{1}-\omega,E_{2}) \\
&=\frac{2 \pi \gamma G_{n \uparrow}^{0r}\left(E_{1}\right) G_{n \downarrow}^{0r}\left(E_{1}-\omega\right) \delta\left(E_{1}-\omega-E_{2}\right) }{1-\gamma^{2} G_{n \uparrow}^{0r}\left(E_{1}-\omega\right) G_{n \uparrow}^{0r}\left(E_{1}\right) }
\end{split}
\end{equation}
\begin{equation}
\begin{split}
G_{n \downarrow, m \uparrow}^{r}\left(E_{1}, E_{2}\right) &= \gamma G_{n \downarrow}^{0r} \left(E_{1}\right) G_{n \uparrow, m \uparrow}^{r}(E_{1}+\omega,E_{2}) \\
&=\frac{2 \pi\gamma G_{n \uparrow}^{0r}\left(E_{1}+\omega\right) G_{n \downarrow}^{0r} \left(E_{1}\right) \delta(E_{1}+\omega-E_{2}) }{1-\gamma^{2} G_{n \uparrow}^{0r}\left(E_{1}+\omega\right) G_{n \downarrow}^{0r}\left(E_{1}\right)}
\end{split}
\end{equation}
\section{Calcualte $\Sigma_{\alpha,mn}$}
In Eq. (\ref{eq:})
