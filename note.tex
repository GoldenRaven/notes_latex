...
&\quad + (2 \pi \gamma)^{2} G_{\uparrow}^{0 r}\left(E_{1}\right) g_{\downarrow}^{r}\left(E_{1}-\omega\right)  G_{\uparrow}^{0 r*}\left(E_{2}\right) g_{\downarrow}^{r*}\left(E_{2}-\omega\right) \delta\left(E_{1}-\omega-E\right) \delta\left(E_{2}-\omega-E\right)
\end{split}
\end{equation}
the $G_{2}$ term is
\begin{equation}
...
&\quad+\int \frac{d E}{2 \pi} i f(E) \Gamma(E) (2 \pi \gamma)^{2} G_{\uparrow}^{0 r}\left(E_{1}\right) g_{\downarrow}^{r}\left(E_{1}-\omega\right)  G_{\uparrow}^{0 r*}\left(E_{2}\right) g_{\downarrow}^{r*}\left(E_{2}-\omega\right) \delta\left(E_{1}-\omega-E\right) \delta\left(E_{2}-\omega-E\right)\\
&= 2\pi i f(E_{1}) \Gamma(E_{1}) g_{\uparrow}^{r}\left(E_{1}\right)  g_{\uparrow}^{r,*}\left(E_{2}\right) \delta(E_{2}-E_{1}) \\
&\quad+ 2\pi \gamma^{2} i f(E_{1}-\omega) \Gamma(E_{1}-\omega) G_{\uparrow}^{0 r}\left(E_{1}\right) g_{\downarrow}^{r}\left(E_{1}-\omega\right)  G_{\uparrow}^{0 r*}\left(E_{2}\right) g_{\downarrow}^{r*}\left(E_{2}-\omega\right) \delta(E_{2}-E_{1})
\end{split}
\end{equation}
...
\end{equation}
\begin{equation}
G_{11}^{<}(E_{1},E_{2}) = 2\pi [A(E_{1},E_{2})+B(E_{1},E_{2})] \delta(E_{2}-E_{1}),
\label{eq:G11}
\end{equation}
in which
\begin{equation}
A(E_{1},E_{2})= i f(E_{1}) \Gamma(E_{1}) g_{\uparrow}^{r}\left(E_{1}\right)  g_{\uparrow}^{r,*}\left(E_{2}\right)
\end{equation}
\begin{equation}
B(E_{1},E_{2}) = \gamma^{2} i f(E_{1}-\omega) \Gamma(E_{1}-\omega) G_{\uparrow}^{0 r}\left(E_{1}\right) g_{\downarrow}^{r}\left(E_{1}-\omega\right)  G_{\uparrow}^{0 r*}\left(E_{2}\right) g_{\downarrow}^{r*}\left(E_{2}-\omega\right) .
\end{equation}
Substitute Eq. (\ref{eq:Gupup}) (\ref{eq:Gupupa}) and (\ref{eq:G11}) into (\ref{eq:current4}), we have
\begin{equation}
\begin{split}
I_{\alpha\uparrow,\uparrow}(\omega_{1})&= -\frac{e}{\hbar}\int dE g_{\uparrow}^{r}(E+\omega_{1}) if(E)\Gamma_{\alpha}(E)\delta(\omega_{1}) + [A(E+\omega_{1},E)+B(E+\omega_{1},E)]\delta(-\omega_{1}) \Sigma_{\alpha}^{a}(E)\\
&\quad -if\left(E+\omega_{1}\right) \Gamma_{\alpha}\left(E+\omega_{1}\right) g_{\uparrow}^{a}\left(E+\omega_{1}\right) \delta(\omega_{1}) - \Sigma_{\alpha}^{r}\left(E+\omega_{1}\right) [A(E+\omega_{1},E)+B(E+\omega_{1},E)]\delta(-\omega_{1})
\end{split}
\label{eq:current5}
\end{equation}
Omit $\omega_{1}$, we get
\begin{equation}
\begin{split}
I_{\alpha\uparrow,\uparrow}&= -\frac{e}{\hbar}\int dE g_{\uparrow}^{r}(E) if(E)\Gamma_{\alpha}(E) + [A(E)+B(E)] \Sigma_{\alpha}^{a}(E)\\
&\quad-if\left(E\right) \Gamma_{\alpha}\left(E\right) g_{\uparrow}^{a}\left(E\right)  - \Sigma_{\alpha}^{r}\left(E\right) [A(E)+B(E)] \\
&=-\frac{e}{\hbar}\int dE \big[g_{\uparrow}^{r}(E) - g_{\uparrow}^{a}\left(E\right) + A(E)+B(E) \big] if(E)\Gamma_{\alpha}(E) ,
\end{split}
\label{eq:current6}
\end{equation}
in which,
...
\end{equation}
\begin{equation}
A(E)= i f(E) \Gamma(E) g_{\uparrow}^{r}\left(E\right)  g_{\uparrow}^{r,*}\left(E\right)
\end{equation}
\begin{equation}
B(E) = \gamma^{2} i f(E-\omega) \Gamma(E-\omega) G_{\uparrow}^{0 r}\left(E\right) g_{\downarrow}^{r}\left(E-\omega\right)  G_{\uparrow}^{0 r*}\left(E\right) g_{\downarrow}^{r*}\left(E-\omega\right) .
\end{equation}
